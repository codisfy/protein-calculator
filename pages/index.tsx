...
import ProteinCalculator, {
  RowStructure,
} from "../components/ProteinCalculator"
import {
  Button,
...
const Home: NextPage = () => {
  ...
  const addProtein = () => {
    setProteins([...proteins, { ...baseStructure, ...{ id: nanoid(), currency } }])
  }
    ...
    <div className={"container-fluid"}>
      ...
      <header className="pb-3 m-4 border-bottom d-flex justify-content-between align-items-center">
        <span className="fs-4">Protein Value Calculator</span>
          <div>
            <CurrencyDropdown currencies={['$', '₹', '£']} onCurrencyChange={onCurrencyChange} currency={currency}></CurrencyDropdown>
          </div>
      </header>
